        ...
        <el-table-column label="操作" align="center">
          ...
          <template slot-scope="scope">
            <el-tooltip effect="dark" content="编辑用户" placement="top" :enterable="false">
              <el-button type="success" icon="el-icon-edit" circle size="mini" @click="showEditDialog"></el-button>
            </el-tooltip>
...
<!--      底部区域-->
    ...
    <el-button type="success" @click="editDialogVisible = false">确 定</el-button>
  </span>
    </el-dialog>
  </div>
</template>
