...
export default {
  ...
  methods: {
        ...
        size: self.orderinfo.size, week1: self.chooseWeek1, week2: self.chooseWeek2,labnum: self.labnum
          ...
          .then(res => {
            ...
            for(let i = 0;i <res.data.records.length; i ++) {
              self.color.push({s1:false,s2:false,s3:false,s4:false,s5:false,s6:false,s7:false,s8:false,s9:false,s10:false,s11:false,s12:false})
              self.ordersdate.push({state:'',date:'',username:'',labname:'',labnum:''})
    ...
    adduserorders() {
      self = this
      for (let i =0;i<self.ordersdate.length;i++) {
